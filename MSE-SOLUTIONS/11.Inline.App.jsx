...
function App() {
  const imageUrl = "https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=500";
  ...
  return (
    <div style={{ padding: '40px', textAlign: 'center', backgroundColor: '#f4f4f9', minHeight: '100vh' }}>
      ...
      <div style={{ 
        ...
        <img src={imageUrl} alt="Tech" style={{ width: '100%', borderRadius: '10px', marginBottom: '15px' }} />
